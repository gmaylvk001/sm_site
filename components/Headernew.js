        ...
        <header className="sticky top-0 z-50">
            ...
            <div className={`${isMobileMenuOpen ? "fixed inset-0 mt-0 pt-0 z-50 overflow-y-auto" : "bg-white px-4 sm:px-6 md:px-6 py-0 sticky top-0 z-40"}`}>
                ...
                <div className="hidden sm:grid grid-cols-12 w-full py-2 px-4 bg-white items-center">
                  ...
                  {/* LEFT â€” LOGO (3 columns, centered) */}
                  ...
                  {/* CENTER â€” SEARCH BAR (6 columns, centered) */}
                  <div className="col-span-6 flex justify-center items-center">
                    {/* CENTER â€” SEARCH BAR (reduced height + clean) */}
                    <div
                  ...
                  {/* RIGHT â€” ICONS (3 columns, centered) */}
                  <div className="col-span-3 flex justify-center items-center gap-6">
                    ...
                    <Link href="/wishlist" className="relative">
                      <FiHeart size={18} className="text-red-600" />
                            ...
                            {forgotStep === 2 && (
                                <>
                                    ...
                                    <form onSubmit={async (e) => {
                                        ...
                                        <input type="text" placeholder="Enter OTP" value={forgotOTP} onChange={(e) => setForgotOTP(e.target.value)} required className="w-full px-4 py-2 border rounded focus:outline-none focus:ring-2 focus:ring-red-500" />
                                        {forgotPasswordError && (
                                            <p className="text-red-500 text-sm">{forgotPasswordError}</p>
                                        )}
                                        {forgotPasswordMessage && (
                                        ...
                                        <button type="submit" disabled={forgotPasswordLoading} className="w-full bg-red-500 text-white py-2 rounded hover:bg-red-600 disabled:bg-gray-400">
                            ...
                            {forgotStep === 3 && (
                                <>
                                    ...
                                    <form onSubmit={async (e) => {
                                        ...
                                        <input type="password" placeholder="New Password" value={newPassword} onChange={(e) => setNewPassword(e.target.value)} required minLength={6} className="w-full px-4 py-2 border rounded focus:outline-none focus:ring-2 focus:ring-red-500" />
                                        <input type="password" placeholder="Confirm New Password" value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)} required minLength={6} className="w-full px-4 py-2 border rounded focus:outline-none focus:ring-2 focus:ring-red-500" />
                                        {forgotPasswordError && (
                                            <p className="text-red-500 text-sm">{forgotPasswordError}</p>
                                        )}
                                        {forgotPasswordMessage && (
            ...
            <div className="hidden sm:flex relative p-0 mt-0 px-1 bg-gradient-to-r from-[#ed3237] to-[#c11116] min-h-[64px] border-gray-200 shadow items-center">
