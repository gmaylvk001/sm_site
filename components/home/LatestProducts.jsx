...
{/*
            <button className="bg-linear-to-r from-red-700 to-red-500 text-white px-3 py-2 rounded-md text-sm font-semibold">
              View All
            </button>
            */}
          </div>
        ...
        <div className="relative md:col-span-1 lg:col-span-2 z-0 pt-10">
          ...
          <div className="latest-next absolute z-50 -right-4 top-1/2 -translate-y-1/2 w-8 h-8 bg-primary rounded-full flex items-center justify-center cursor-pointer">
